...
const Container = styled.div`
  ...
  .rccs__card--maestro .rccs__card__background {
    background: linear-gradient(25deg, #FFFF00, #FFFF00);
  }
  .rccs__card--mastercard .rccs__card__background {
    // background: linear-gradient(25deg, #f37b26, #fdb731);
    background: linear-gradient(25deg, lightblue, lightblue);
  }
  ...
  .rccs__card--visaelectron .rccs__card__background {
    background: linear-gradient(25deg, #32CD32, #32CD32);
  }
...
class Card extends Component {
  ...
  static propTypes = {
    ...
    //   PropTypes.number,
    // ]).isRequired,
    expirationMonth: PropTypes.oneOfType([
      PropTypes.string,
      PropTypes.number,
    ]).isRequired,
    expirationYear: PropTypes.oneOfType([
      PropTypes.string,
      PropTypes.number,
    ]).isRequired,
  ...
  get expirationMonth() {
      const { expirationMonth = '' } = this.props;
      const date = typeof expirationMonth === 'number' ? expirationMonth.toString() : expirationMonth;
      let month = '';
      month = date.substr(0, 2);
  ...
  get expirationYear() {
    ...
    const date = typeof expirationYear === 'number' ? expirationYear.toString() : expirationYear;
    let year = '';
  ...
  get options() {
    ...
    // const issuer = getCardType(number) || 'unknown'
  ...
  render() {
    ...
    const { number, expirationMonth, expirationYear } = this;
        ...
        <div key="Cards" className="rccs">
          ...
          >
            <div className="rccs__card--front">
              ...
              <div className='rccs__name_head'>Card Holder</div>
              <div
                className={[
                  'rccs__name',
            ...
            <div
                className={[
                  'rccs__expiry',
                  focused === 'expirationMonth' || focused === 'expirationYear' ? 'rccs--focused' : '',
                  expirationMonth.substr(0, 1) !== 'M' ? 'rccs--filled' : '',
                ].join(' ').trim()}
              >
                <div className="rccs__expiry__valid">{locale.valid}</div>
                <div className="rccs__expiry__value">{expirationMonth}</div>
            </div>
            <div
                className={[
                  'rccs__expiry_year',
                  focused === 'expirationYear' ? 'rccs--focused' : '',
                  expirationYear.substr(0, 1) !== 'Y' ? 'rccs--filled' : '',
                ].join(' ').trim()}
              >
                {/* <div className="rccs__expiry__valid">{locale.valid}</div> */}
                <div className="rccs__expiry__value">/{expirationYear}</div>
            </div>
            <div className="rccs__chip" />
            </div>
